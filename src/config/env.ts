...
export const ConfigEnv = (name: TYPE_ENV = "development") => {
    let envFile = '.env';
    ...
    if (name === "production") {
        return {
            ...
            DATABASE_URL: process.env.DATABASE_URL || "postgresql://username:password@production-host:5432/mydb_prod",
            JWT_SECRET: process.env.JWT_SECRET || "",
            JWT_EXPIRES_IN: process.env.JWT_EXPIRES_IN || "1d",
            JWT_ISSUER: process.env.JWT_ISSUER || "wafiuddinwafiq-prod",
        };
    }
    ...
    if (name === "test") {
        return {
            ...
            DATABASE_URL: process.env.DATABASE_URL || "postgresql://username:password@localhost:5432/mydb_test",
